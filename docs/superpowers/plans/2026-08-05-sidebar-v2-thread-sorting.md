...
| `apps/web/src/components/Sidebar.tsx`                          | Reads the setting, renders the menu, passes `sortOrder` to the comparator | Modify     |
...
In `apps/web/src/components/Sidebar.tsx`, find the settings reads around line 1198-1201:
...
```bash
pnpm typecheck
pnpm exec vp lint apps/web/src/components/Sidebar.tsx apps/web/src/components/sidebar/SidebarSortMenu.tsx
```
...
```bash
git add apps/web/src/components/sidebar/SidebarSortMenu.tsx apps/web/src/components/Sidebar.tsx
