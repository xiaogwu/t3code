  ...
  return (
    <div
      ...
      className={cn(
        ...
        // The composer overlaps a virtualized scroller. Sampling its backdrop makes
        // Chromium repaint the entire surface when scrolling becomes idle.
        "before:pointer-events-none before:absolute before:inset-0 before:z-0 before:rounded-[22px] before:bg-(--chat-composer-glass-surface)",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-has-data-[composer-banner-surface=attached]/composer-surface:bg-(--chat-composer-glass-surface)",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-has-data-[composer-banner-surface=attached]/composer-surface:before:bg-(--chat-composer-glass-surface)",
        "not-supports-[clip-path:shape(from_0_0,line_to_1px_1px)]:before:bg-(--chat-composer-glass-surface)",
        className,
      )}
      {...props}
    />
