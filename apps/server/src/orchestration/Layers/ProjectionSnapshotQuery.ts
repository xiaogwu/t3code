...
pending_approval_requests AS (
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                spawnKey: row.spawnKey ?? undefined,
                ...
                agentSettleTurnId: row.agentSettleTurnId,
                agentSettleRequestedAt: row.agentSettleRequestedAt,
                agentSettleReason: row.agentSettleReason,
                snoozedUntil: row.snoozedUntil,
                snoozedAt: row.snoozedAt,
                snoozedTurnId: row.snoozedTurnId ?? null,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        parentTurnId: threadRow.value.parentTurnId ?? null,
        spawnKey: threadRow.value.spawnKey ?? undefined,
        ...mapThreadPullRequests(
        ...
        agentSettleTurnId: threadRow.value.agentSettleTurnId,
        agentSettleRequestedAt: threadRow.value.agentSettleRequestedAt,
        agentSettleReason: threadRow.value.agentSettleReason,
        snoozedUntil: threadRow.value.snoozedUntil,
        snoozedAt: threadRow.value.snoozedAt,
        snoozedTurnId: threadRow.value.snoozedTurnId ?? null,
  ...
  const getTurnStartMessage: ProjectionSnapshotQueryShape["getTurnStartMessage"] = Effect.fn(
    ...
    return Option.map(message, (row) => ({
      message: mapProjectedMessage(row),
