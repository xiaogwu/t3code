...
describe("ProviderCommandReactor", () => {
  ...
  // The seed arrives through createHarness rather than a thread.meta.update dispatch: a rename
  // stamps titleState.source = "manual", which skips first-turn generation altogether.
