    ...
    execute: (row) =>
      sql`
        INSERT INTO projection_threads (
          ...
          settled_at,
          unsettled_at,
          agent_settle_turn_id,
          agent_settle_requested_at,
          agent_settle_reason,
          snoozed_until,
          snoozed_at,
          snoozed_turn_id,
        ...
        VALUES (
          ...
          ${row.settledAt},
          ${row.unsettledAt},
          ${row.agentSettleTurnId},
          ${row.agentSettleRequestedAt},
          ${row.agentSettleReason},
          ${row.snoozedUntil},
          ${row.snoozedAt},
          ${row.snoozedTurnId ?? null},
          ${row.pinnedAt},
          ${row.pinOrderKey ?? null},
          ${row.activeOrderKey ?? null},
          ${row.titleRegenerationRequestId ?? null},
          ${row.titleRegenerationStartedAt ?? null},
          ${row.titleProvenance ?? null},
          ${row.titleProtectedPrefix ?? null},
          ${row.titleTurnsSincePolicyEval ?? null},
        ...
        DO UPDATE SET
          ...
          agent_settle_turn_id = excluded.agent_settle_turn_id,
          agent_settle_requested_at = excluded.agent_settle_requested_at,
          agent_settle_reason = excluded.agent_settle_reason,
          snoozed_until = excluded.snoozed_until,
          snoozed_at = excluded.snoozed_at,
          snoozed_turn_id = excluded.snoozed_turn_id,
          ...
          title_protected_prefix = excluded.title_protected_prefix,
          title_turns_since_policy_eval = excluded.title_turns_since_policy_eval,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          agent_settle_turn_id AS "agentSettleTurnId",
          agent_settle_requested_at AS "agentSettleRequestedAt",
          agent_settle_reason AS "agentSettleReason",
          snoozed_until AS "snoozedUntil",
          snoozed_at AS "snoozedAt",
          snoozed_turn_id AS "snoozedTurnId",
