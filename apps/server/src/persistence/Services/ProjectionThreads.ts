...
export const ProjectionThread = Schema.Struct({
  ...
  spawnKey: Schema.optional(Schema.NullOr(Schema.String)),
  ...
  agentSettleTurnId: Schema.NullOr(TurnId),
  agentSettleRequestedAt: Schema.NullOr(IsoDateTime),
  ...
  titleProvenance: Schema.optional(Schema.NullOr(Schema.Literals(["automatic", "manual"]))),
  titleProtectedPrefix: Schema.optional(Schema.NullOr(Schema.String)),
  titleTurnsSincePolicyEval: Schema.optional(Schema.NullOr(NonNegativeInt)),
